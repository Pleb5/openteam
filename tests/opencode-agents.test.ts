...
describe("opencode helper agents", () => {
  ...
  test("writes role-specific primary agents under .opencode/agent", async () => {
    ...
    expect(builder).toContain("read: allow")
    expect(builder).toContain("glob: allow")
    expect(builder).toContain("grep: allow")
    expect(builder).toContain("list: allow")
    expect(builder).toContain("webfetch: allow")
    expect(builder).toContain("websearch: allow")
    expect(builder).toContain("external_directory:")
    expect(builder).toContain(`${path.dirname(checkout)}/.openteam-runtime/tmp/**`)
    expect(builder).toContain(`${path.dirname(checkout)}/.openteam-runtime/cache/**`)
    expect(builder).toContain(`${path.dirname(checkout)}/.openteam-runtime/artifacts/**`)
    expect(builder).toContain(`${path.dirname(checkout)}/.openteam-runtime/opencode/**`)
    expect(builder).toContain("edit: allow")
    expect(builder).toContain("task: allow")
    ...
    expect(researcher).toContain("webfetch: allow")
    expect(researcher).toContain("websearch: allow")
    expect(researcher).toContain("external_directory:")
    expect(researcher).toContain("task: allow")
    ...
    expect(builder).not.toContain("bash:")
