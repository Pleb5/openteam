...
describe("task manifest", () => {
  ...
  test("builds the structured worker handoff without leaking secrets", () => {
    ...
    expect(manifest.environment.runtimePath).toBe("/work/.openteam-runtime")
    expect(manifest.environment.cachePath).toBe("/work/.openteam-runtime/cache")
    expect(manifest.environment.scratchPath).toBe("/work/.openteam-runtime/tmp")
    expect(manifest.environment.artifactsPath).toBe("/work/.openteam-runtime/artifacts")
